...
public class PingPongClientVsAI extends JFrame {
    ...
    private void gameLoop() {
        ...
        // Improved AI movement for paddle2
        int aiSpeed = 8; // Increase AI speed
        if (ball.xVelocity > 0 && ball.x > WIDTH / 2) { // Ball moving towards AI paddle
            ...
            if (paddle2.y + paddle2.height / 2 < HEIGHT / 2) {
                paddle2.smoothMoveDown(aiSpeed / 2);
            } else if (paddle2.y + paddle2.height / 2 > HEIGHT / 2) {
                paddle2.smoothMoveUp(aiSpeed / 2);
            }
        }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(PingPongClientVsAI::new);
    }
    ...
    class Ball {
        int x, y;
        int diameter = 20;
        int xVelocity = 8, yVelocity = 8; // Increased ball speed
